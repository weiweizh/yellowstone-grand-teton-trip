...
const timeCopy = { Flight: '航班', Midday: '中午', Morning: '早晨', Evening: '晚上', 'After sunset': '日落后', 'Day plan': '全天', '6:00 AM – 11:21 AM': '上午6:00 – 11:21', '6:30 AM': '早上6:30', '11:00–11:30 AM': '上午11:00–11:30', '2:30 PM': '下午2:30', '4:15 PM – 1:15 AM': '下午4:15 – 凌晨1:15' };
...
function renderActivity(activity, dayIndex, activityIndex) {
  ...
  const alternate = language === 'en' ? activity.titleZh : activity.title;
